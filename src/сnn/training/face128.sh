...
#BSUB -o /dtu/blackhole/14/204020/deep-learning/job_out/faces_%J.out
#BSUB -e /dtu/blackhole/14/204020/deep-learning/job_out/faces_%J.err
...
python /dtu/blackhole/14/204020/deep-learning/faces128.py
